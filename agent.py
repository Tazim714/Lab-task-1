...
class Agent(pygame.sprite.Sprite):
    ...
    def find_nearest_task(self):
        """Find the nearest task and calculate a path to it."""
        ...
        # Calculate path to the nearest task
        self.path = self.find_path_to(nearest_task, algorithm='UCS')
        self.moving = True  # Start moving along the path
